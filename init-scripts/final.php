...
; Copyright (C) Z-Coders 2017\n";
  ...
  $table_config = array(
                  ...
                  "event_name varchar(64), event_id varchar(32) not null unique, event_incharge varchar(128), incharge_contact varchar(128), event_fee varchar(16), event_prize varchar(16), description mediumtext",
